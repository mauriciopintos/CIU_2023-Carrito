...
// import { Col, Row, fab } from 'react-bootstrap';
...
const Footer = ({redsocial}) => {
    ...
    return (
        <div className="App-footer bg-secondary text-light text-center">
            <div className='redes'>
            ...
            <p>Todo el contenido es utilizado con fines didácticos a los fines del 1er Parcial</p>
